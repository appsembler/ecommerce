...
class Payflow(BasePaymentProcessor):
    ...
    def get_transaction_parameters(self, basket, request=None, use_client_side_checkout=False, **kwargs):
        ...
        data = "PARTNER={}&PWD={}&VENDOR={}&USER={}&TRXTYPE={}&AMT={}&CURRENCY={}&CREATESECURETOKEN=Y&SECURETOKENID={}".format(
            PAYFLOW_PARTNER,
            Payflow_PASSWORD,
            VENDOR_ID,
            Payflow_USER,
        ...
        resp, content = h.request("https://pilot-payflowpro.paypal.com", "POST", data)
        ...
        payment_page_url = "https://pilot-payflowlink.paypal.com?SECURETOKENID={}&SECURETOKEN={}&PONUM={}&INVNUM={}&COMMENT2={}&TEMPLATE={}".format(
            token_id,
            token,
            basket.order_number,
            basket.order_number,
